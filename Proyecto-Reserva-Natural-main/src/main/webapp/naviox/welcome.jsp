...
In proyectoReservaa-labels_en.properties:
proyectoReservaa=My application
proyectoReservaa[description]=My application does this and that

In proyectoReservaa-messages_en.properties:
